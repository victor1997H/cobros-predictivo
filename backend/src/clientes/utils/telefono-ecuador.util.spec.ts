import { normalizeEcuadorianMobilePhone } from './telefono-ecuador.util';

describe('normalizeEcuadorianMobilePhone', () => {
  it.each([
  ...
  it.each(['abc123', '09875', '+593593987545679'])('rechaza %s', (input) => {
